...
export default function Nav({ className }: { className?: string}) {
    ...
    return (
        <>
            <div className={`w-1/6 min-h-full bg-background-900 border-text-200 border-r-[1px] relative text-text-50 max-lg:absolute max-lg:w-full max-lg:z-20 ${className}`}>
