        ...
        <>
            <div className="bg-background-900 min-h-screen min-w-screen flex">
                ...
                <div className='bg-background-950 min-h-full w-1/2 flex items-center justify-center relative max-lg:w-full'>
                    ...
                    <Button onClick={() => window.location.href = "/register"} className='absolute top-8 right-8 bg-secondary-800 hover:bg-secondary-900 px-8 py-6 text-text-50 font-bold text-xl'>Register</Button>
